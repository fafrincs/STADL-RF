...
class tfOpts():
    def __init__(self, source_path, location, file_key='*.bin', num_slice=10000, start_ix=0, slice_len=288, stride=288):
...
def rank_model_test():
    modelPath = '/lustre/work/swanlab/fafrin2/usrp200/outlab_outdoor/after_fft/crelu/s288/res_out/modelDir/IQ_model_out_lab_complex_after_fft_slices_10000_startIdx_300000_stride_288_len_288_STFT_64.h5'
    ...
    m.summary()
    dataPath = "/work/swanlab/fafrin2/usrp_b200/out_door/out_door/"
    opts = tfOpts(source_path=dataPath, location='after_fft')
    dataOpts = load_slice_IQ.loadDataOpts(opts.root_dir, opts.location, num_slice=10000, slice_len=288, stride=288,
                                          start_idx=0, sample=False, dataType='IQ')
    # test_time = 3

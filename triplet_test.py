...
def run(opts):
    ...
    modelPath = "/lustre/work/swanlab/fafrin2/usrp200/outlab_outdoor/after_fft/crelu/s288/TF/res_out/modelDir/complex_triplet_out_lab_400_False.h5"
    for tsn in tsnList:
...
class tfOpts():
    def __init__(self, source_path, test_path, location, file_key='*.bin', num_slice=10000, start_ix=0, slice_len=288,

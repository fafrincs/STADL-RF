                ...
                for j in ['cart']:
                    for p in data:
                       # dataPath = 'C:/Users/fafrin2/Downloads/hackrf/our_day1/' + p[0]
                        ...
                        dataPath = '/work/swanlab/fafrin2/usrp_b200/out_lab/'+p[0]
                        testPath = '/work/swanlab/fafrin2/usrp_b200/out_door/'+p[1]
                    opts = testOpts(trainData=dataPath, testData=testPath, location='after_fft', modelType=m,
